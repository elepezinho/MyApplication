...
public class PhpActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_11:
                startActivity(new Intent(PhpActivity.this,PhpActivity.class));
                finish();
                break;
            case R.id.nav_01:
                startActivity(new Intent(PhpActivity.this,ArduinoActivity.class));
                finish();
                break;
            case R.id.nav_02:
                startActivity(new Intent(PhpActivity.this,CMaisMaisActivity.class));
                finish();
                break;
            case R.id.nav_03:
                startActivity(new Intent(PhpActivity.this,CssActivity.class));
                finish();
                break;
            case R.id.nav_04:
                startActivity(new Intent(PhpActivity.this,HtmlActivity.class));
                finish();
                break;
            case R.id.nav_05:
                startActivity(new Intent(PhpActivity.this,JavaActivity.class));
                finish();
                break;
            case R.id.nav_06:
                startActivity(new Intent(PhpActivity.this,JavaScriptActivity.class));
                finish();
                break;
            case R.id.nav_07:
                startActivity(new Intent(PhpActivity.this,PhpActivity.class));
                ...
                break;
            case R.id.nav_08:
                startActivity(new Intent(PhpActivity.this,PythonActivity.class));
                finish();
                break;
            case R.id.nav_09:
                startActivity(new Intent(PhpActivity.this,RubyActivity.class));
                finish();
                break;
            case R.id.nav_10:
                startActivity(new Intent(PhpActivity.this,SwiftActivity.class));
                finish();
                break;
        }
