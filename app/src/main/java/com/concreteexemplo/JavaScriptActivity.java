...
public class JavaScriptActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = JavaScriptActivity.class.getSimpleName();
    private final String QUERYL = "language:JavaScript";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_11:
                startActivity(new Intent(JavaScriptActivity.this,MainActivity.class));
                finish();
                break;
            case R.id.nav_01:
                startActivity(new Intent(JavaScriptActivity.this,ArduinoActivity.class));
                finish();
                break;
            case R.id.nav_02:
                startActivity(new Intent(JavaScriptActivity.this,CMaisMaisActivity.class));
                finish();
                break;
            case R.id.nav_03:
                startActivity(new Intent(JavaScriptActivity.this,CssActivity.class));
                finish();
                break;
            case R.id.nav_04:
                startActivity(new Intent(JavaScriptActivity.this,HtmlActivity.class));
                finish();
                break;
            case R.id.nav_05:
                startActivity(new Intent(JavaScriptActivity.this,JavaActivity.class));
                finish();
                break;
            case R.id.nav_06:
                startActivity(new Intent(JavaScriptActivity.this,JavaScriptActivity.class));
                finish();
                break;
            case R.id.nav_07:
                startActivity(new Intent(JavaScriptActivity.this,PhpActivity.class));
                finish();
                break;
            case R.id.nav_08:
                startActivity(new Intent(JavaScriptActivity.this,PythonActivity.class));
                finish();
                break;
            case R.id.nav_09:
                startActivity(new Intent(JavaScriptActivity.this,RubyActivity.class));
                finish();
                break;
            case R.id.nav_10:
                startActivity(new Intent(JavaScriptActivity.this,SwiftActivity.class));
                finish();
                break;
        }
