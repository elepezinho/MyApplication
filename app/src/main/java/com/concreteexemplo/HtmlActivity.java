...
public class HtmlActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = HtmlActivity.class.getSimpleName();
    private final String QUERYL = "language:Html";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_11:
                startActivity(new Intent(HtmlActivity.this,HtmlActivity.class));
                finish();
                break;
            case R.id.nav_01:
                startActivity(new Intent(HtmlActivity.this,ArduinoActivity.class));
                finish();
                break;
            case R.id.nav_02:
                startActivity(new Intent(HtmlActivity.this,CMaisMaisActivity.class));
                finish();
                break;
            case R.id.nav_03:
                startActivity(new Intent(HtmlActivity.this,CssActivity.class));
                finish();
                break;
            case R.id.nav_04:
                startActivity(new Intent(HtmlActivity.this,HtmlActivity.class));
                ...
                break;
            case R.id.nav_05:
                startActivity(new Intent(HtmlActivity.this,JavaActivity.class));
                finish();
                break;
            case R.id.nav_06:
                startActivity(new Intent(HtmlActivity.this,JavaScriptActivity.class));
                finish();
                break;
            case R.id.nav_07:
                startActivity(new Intent(HtmlActivity.this,PhpActivity.class));
                finish();
                break;
            case R.id.nav_08:
                startActivity(new Intent(HtmlActivity.this,PythonActivity.class));
                finish();
                break;
            case R.id.nav_09:
                startActivity(new Intent(HtmlActivity.this,RubyActivity.class));
                finish();
                break;
            case R.id.nav_10:
                startActivity(new Intent(HtmlActivity.this,SwiftActivity.class));
                finish();
                break;
        }
