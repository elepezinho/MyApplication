...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private final String QUERYL = "languages";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_01:
                ...
                break;
            case R.id.nav_02:
                startActivity(new Intent(MainActivity.this,CMaisMaisActivity.class));
                finish();
                break;
            case R.id.nav_03:
            ...
            case R.id.nav_08:
                ...
                break;
            case R.id.nav_09:
                startActivity(new Intent(MainActivity.this,RubyActivity.class));
                finish();
                break;
            case R.id.nav_10:
                startActivity(new Intent(MainActivity.this,SwiftActivity.class));
                finish();
                break;
        }
